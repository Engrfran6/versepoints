  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-border bg-sidebar">
      <div className="flex h-full flex-col">
        {/* Logo */}
        <Link href="/dashboard" className="flex h-16 items-center gap-2 border-b border-sidebar-border px-6 group">
          <div className="w-8 h-8 rounded-lg overflow-hidden">
            <img src="/logo.jpg" alt="VerseEstate" className="w-full h-full object-cover" />
          </div>
