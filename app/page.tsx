...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      {/* Whitepaper Section */}
      <section id="whitepaper" className="relative py-24 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-xl bg-card/50 border border-border/50 backdrop-blur-sm hover:border-primary/30 transition-all">
                <h3 className="text-xl font-bold text-foreground mb-2">Platform Overview</h3>
                <p className="text-muted-foreground">
                  Discover how VerseEstate combines Web2 accessibility with Web3 technology to create a sustainable
                  points mining ecosystem with real-world value.
                </p>
              </div>
              ...
              <Link href="/dashboard/whitepaper">
                <Button
                  size="lg"
      ...
      {/* Security Section */}
      <section className="py-32 px-4 bg-gradient-to-b from-transparent via-card/20 to-transparent">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="https://youtube.com/@verseestate001?si=x4cHGhBypOZyW1W_"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-muted/50 hover:bg-primary/20 flex items-center justify-center transition-colors"
                  aria-label="YouTube"
                ...
                <a
                  href="https://www.tiktok.com/@verseestate5?_r=1&_t=ZS-926FGcRqut5"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-muted/50 hover:bg-primary/20 flex items-center justify-center transition-colors"
                  aria-label="TikTok"
                ...
                <a
                  href="https://www.instagram.com/verse_estate?igsh=ZXpuOGZwanVybDFw"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-muted/50 hover:bg-primary/20 flex items-center justify-center transition-colors"
                ...
                <a
                  href="https://discord.gg/2RtpUKYt"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-muted/50 hover:bg-primary/20 flex items-center justify-center transition-colors"
                  aria-label="Discord"
                ...
                <a
                  href="https://whatsapp.com/channel/0029VbBlIG7CXC3SvpwBTF2U"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-muted/50 hover:bg-primary/20 flex items-center justify-center transition-colors"
                  aria-label="WhatsApp"
