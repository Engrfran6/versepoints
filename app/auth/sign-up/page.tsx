...
const SignupPortal3D = dynamic(() => import("@/components/3d/signup-portal-3d").then((mod) => mod.SignupPortal3D), {
  ssr: false,
})
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card className="bg-card/90 backdrop-blur-sm border-border">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-muted-foreground">Start mining VersePoints today</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        onChange={handleChange}
                        className={`bg-input border-border text-foreground ${errors.username ? "border-destructive" : ""}`}
                      />
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          onChange={handleChange}
                          className={`bg-input border-border text-foreground pr-10 ${errors.password ? "border-destructive" : ""}`}
                        />
                        <button
                          type="button"
