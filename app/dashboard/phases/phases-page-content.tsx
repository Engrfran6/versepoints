...
interface PhasesPageContentProps {
  ...
  return (
    <div className="relative p-4 md:p-8 min-h-screen">
      ...
      <div className="relative z-10 mb-8">
        ...
        <p className="text-muted-foreground mt-1">Track the VersePoints platform development journey</p>
      </div>
        ...
        <Card className="col-span-2 md:col-span-1 bg-gradient-to-br from-card/90 to-primary/10 border-border backdrop-blur-sm row-span-2 flex items-center justify-center">
          ...
          >
            <div className="w-32 h-32">
              <PhaseProgressOrb progress={progressPercentage} currentPhase={currentPhase?.phase_number || 1} />
            </div>
          </Suspense>
        </Card>
        ...
        <Card className="bg-card/90 backdrop-blur-sm border-border">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{currentPhase?.phase_number || 1}</p>
        ...
        <Card className="bg-card/90 backdrop-blur-sm border-border">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-foreground">{totalPhases - completedPhases - 1}</p>
      ...
      <Card className="relative z-10 bg-card/90 backdrop-blur-sm border-border mb-8">
        ...
        <CardContent className="pb-8">
          <PhaseTimeline phases={phases || []} currentPhaseNumber={currentPhase?.phase_number || 1} />
        </CardContent>
      </Card>
      ...
      <Card className="relative z-10 mt-8 bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20 backdrop-blur-sm">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            VersePoints is building toward a fully decentralized ecosystem where your mining efforts translate into real
            blockchain assets. Our 12-phase roadmap ensures a smooth transition from Web2 to Web3.
          </p>
