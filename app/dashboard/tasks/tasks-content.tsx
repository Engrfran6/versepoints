...
const TaskCheckmark3D = dynamic(() => import("@/components/3d/task-checkmark-3d").then((mod) => mod.TaskCheckmark3D), {
  ssr: false,
})
...
export function TasksContent({ tasks, userTasks }: TasksContentProps) {
  ...
  const handleStartTask = (task: Task) => {
    ...
    // Open the submission modal after a short delay
    setTimeout(() => {
    ...
    <div className="relative p-4 md:p-8 min-h-screen">
      ...
      <Card className="relative z-10 bg-primary/5 backdrop-blur-sm border-primary/20 mt-8">
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">Complete tasks to earn bonus VersePoints</CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Provide a link to your profile, screenshot (uploaded to imgur.com), or any proof of completion
              </p>
            </div>
